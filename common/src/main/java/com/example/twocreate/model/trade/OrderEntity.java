...
import com.example.twocreate.enums.Direction;
import com.example.twocreate.enums.OrderStatus;
...
public class OrderEntity implements EntitySupport, Comparable<OrderEntity> {
    ...
    public void upDateOrder(BigDecimal unfiledQuantity, OrderStatus status, long updatedAt) {
        this.version++;
